...
class GetFoodsByCategory @Inject constructor(private val foodRepository: FoodRepository) :
    UseCase<FoodsResponse, String>(){
    override suspend fun run(params: String) = foodRepository.getFoodsByCategory(params)
